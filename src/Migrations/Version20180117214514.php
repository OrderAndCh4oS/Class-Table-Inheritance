 ...
 */
class Version20180117214514 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql(
            'ALTER TABLE text_block ADD article_id INT DEFAULT NULL, ADD title VARCHAR(255) NOT NULL, ADD `order` INT NOT NULL, ADD section VARCHAR(255) NOT NULL, CHANGE id id INT AUTO_INCREMENT NOT NULL'
        );
        $this->addSql(
        ...
        $this->addSql(
            'ALTER TABLE quote_block ADD article_id INT DEFAULT NULL, ADD title VARCHAR(255) NOT NULL, ADD `order` INT NOT NULL, ADD section VARCHAR(255) NOT NULL, CHANGE id id INT AUTO_INCREMENT NOT NULL'
        );
        $this->addSql(
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql(
            'CREATE TABLE section_abstract (id INT AUTO_INCREMENT NOT NULL, article_id INT DEFAULT NULL, title VARCHAR(255) NOT NULL COLLATE utf8_unicode_ci, `order` INT NOT NULL, section VARCHAR(255) NOT NULL COLLATE utf8_unicode_ci, INDEX IDX_E55805FD7294869C (article_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB'
        );
        $this->addSql(
        ...
        $this->addSql(
            'ALTER TABLE quote_block DROP article_id, DROP title, DROP `order`, DROP section, CHANGE id id INT NOT NULL'
        );
        $this->addSql(
        ...
        $this->addSql(
            'ALTER TABLE text_block DROP article_id, DROP title, DROP `order`, DROP section, CHANGE id id INT NOT NULL'
        );
        $this->addSql(
